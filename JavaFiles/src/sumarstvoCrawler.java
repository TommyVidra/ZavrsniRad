...
public class sumarstvoCrawler{
    ...
    public static void sumarstvo() throws IOException {

        Document savska = Jsoup.connect("http://www.sczg.unizg.hr/prehrana/restorani/sumarstvo/").get(); //savksa

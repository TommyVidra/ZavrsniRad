...
public class borongajCrawler {
    ...
    public static void borongaj() throws IOException {

        Document savska = Jsoup.connect("http://www.sczg.unizg.hr/prehrana/restorani/zuk-borongaj/").get(); //savksa
        ...
        System.out.println(lunchChoiceL);

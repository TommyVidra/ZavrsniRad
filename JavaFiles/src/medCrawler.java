...
public class medCrawler {
    ...
    public static void med() throws IOException {

        Document savska = Jsoup.connect("http://www.sczg.unizg.hr/prehrana/restorani/medicina/").get(); //savksa
